...
const Registration = () => {
  ...
  return (
    <div className='w-full min-h-screen text-green-800'>
      ...
      <div className='absolute flex w-full h-full justify-center items-center opacity-95 bg-green-100 m-y-20 gap-4'>
          <div className='w-full flex justify-center mx-20 p-10 bg-green-300 items-center gap-6'>
          ...
          <div>
            <h2 className=' font-bold md:leading-[3rem] lg:leading-[3.5rem] text-center'>
              <span className='text-xl md:text-2xl text-green-800'>ENVIANDO </span>
              <span className='text-xl md:text-2xl text-green-600'> POSTULACIÓN</span>
            </h2>
          </div>
          </div>
        </div>
